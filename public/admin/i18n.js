...
const legacyTextKeys = Object.freeze({
  ...
  , 'Erzeuge eine verschlüsselte Credential-HUB-Exportdatei. Die Datei kann später über die Import-Vorschau geprüft und eingelesen werden.': 'transfer.exportHelp'
  , 'Dieses Passwort wird zum Entschlüsseln beim Import benötigt.': 'transfer.passwordHelp'
  , 'Füge eine Credential-HUB-Exportdatei oder eine CSV-Migrationsdatei ein. Vor dem Schreiben wird immer zuerst eine Vorschau angezeigt.': 'transfer.importHelp'
  , 'Credential-HUB-Exportdatei': 'transfer.transferFile'
